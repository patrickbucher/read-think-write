---
title: "Disruptors Are Going to Be Disrupted"
...
There was another post on LinkedIn on "AI disruption". The stock of _Duolingo_ ([DUOL](https://finance.yahoo.com/quote/DUOL)) also fell considerably in the last couple of months. Funny enough, it went up steeply from roughly USD 60.- to more than USD 500.- since 2023 to its peak in 2025. Since last spring, it has been falling to roughly one hundred USD. AI cannot account for this alone. And the stock graphs of CHGG and DUOL look entierely different, not showing any common "AI disruption pattern".
...
Of course, publishing houses operate under harsh economic pressure. They will take shortcuts, too. I have no problem with a text that ran through an LLM to eradicate typos. And if an LLM is used to spot incoherences or contradictions, the final text may as well gain in clarity—as long as those issues are processed by the editor or author, rather than "fixed" automatically in an unpredictable way by an LLM.
